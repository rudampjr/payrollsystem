<?php
// Create connection
require_once 'ps_connect_db2.php'
?> 
...
<div id="psLoginContainer">
	<h1><a href="sample_login.php">Payroll Management <span>System</span></a></h1>

<?php
	if(isset($_COOKIE['jl'])) //checking if $_COOKIE['jl'] is set 
?>

	<form action="log-in_php_code.php" method="post" class="form-horizontal" enctype="multipart/form-data">
		<div class="control-group">
			<label class="control-label" for="inputEmail">Username:</label>
			<div class="controls">
				<input type="text" id="inputEmail" name="psUsername" autocomplete="off" required />
			</div>
		</div>
		<div class="control-group">
